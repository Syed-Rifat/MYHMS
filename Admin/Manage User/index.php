...
<body>
    ...
    <div class="manage-user-page">
        <h2 class="text-center">Manage Users Dashboard</h2>
        <div class="card-grid">
            ...
            <div class="card bg-light border-success" onclick="window.location.href='student_requests.php'">
                <div class="card-content">
                    <i class="fas fa-user-clock"></i> <!-- Pending Requests Icon -->
                    <h3>Pending Student Requests</h3>
                    <p><?php echo $student_requests_count; ?></p>
                </div>
            </div>

            <div class="card bg-light border-success" onclick="window.location.href='teacher_requests.php'">
                <div class="card-content">
                    <i class="fas fa-user-clock"></i> <!-- Pending Requests Icon -->
                    <h3>Pending Teacher Requests</h3>
                    <p><?php echo $teacher_requests_count; ?></p>
                </div>
            </div>


            <div class="card bg-light border-success" onclick="window.location.href='admin_requests.php'">
                <div class="card-content">
                    <i class="fas fa-user-clock"></i> <!-- Pending Requests Icon -->
                    <h3>Pending Admin Requests</h3>
                    <p><?php echo $admin_requests_count; ?></p>
                </div>
            </div>
        </div>
    </div>
