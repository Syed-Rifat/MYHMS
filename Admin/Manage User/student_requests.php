...
<head>
    ...
    <title>Admin - Pending Student Registration Requests</title>
                ...
                <tbody>
                    <?php
                       ...
                       if (!$conn) {
                        ...
                        $count_query = "SELECT COUNT(*) AS total FROM student_registration_request WHERE STATUS = 'pending'";
                        ...
                        $query = "SELECT * FROM student_registration_request WHERE STATUS = 'pending' LIMIT $offset, $rows_per_page";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($request = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>{$request['student_id_number']}</td>
                                    <td>{$request['email']}</td>
                                    <td>{$request['phone']}</td>
                                    <td class='text-center'>
                                        <a href='student_approve_request.php?id={$request['request_id']}' class='btn btn-approve btn-sm'>
                                            <i class='fas fa-check-circle'></i> Approve
                                        </a>
                                        <a href='student_reject_request.php?id={$request['request_id']}' class='btn btn-reject btn-sm'>
