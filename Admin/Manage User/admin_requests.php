...
<head>
    ...
    <title>Admin - Pending Admin Registration Requests</title>
...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h3>Pending Admin Registration Requests</h3>
        </div>
        <div class="card-body">
            <!-- Table for admin registration requests -->
                ...
                <tbody>
                    <?php
                       ...
                       if (!$conn) {
                        ...
                        $count_query = "SELECT COUNT(*) AS total FROM admin_registration_request WHERE STATUS = 'pending'";
                        ...
                        $query = "SELECT * FROM admin_registration_request WHERE STATUS = 'pending' LIMIT $offset, $rows_per_page";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($request = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td class='text-center'>
                                        <a href='admin_approve_request.php?id={$request['request_id']}' class='btn btn-approve btn-sm'>
                                            <i class='fas fa-check-circle'></i> Approve
                                        </a>
                                        <a href='admin_reject_request.php?id={$request['request_id']}' class='btn btn-reject btn-sm'>
                            ...
                            echo "<tr><td colspan='4' class='text-center'>No pending registration requests</td></tr>";
                        }
